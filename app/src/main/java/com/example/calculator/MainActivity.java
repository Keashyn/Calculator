...
public class MainActivity extends AppCompatActivity {
        ...
        btnPar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < usersInputBox.getSelectionStart(); i++){
                    if (usersInputBox.getText().toString().startsWith("(", i)){
                        openPar += 1;
                    }
                    else if (usersInputBox.getText().toString().startsWith(")", i)){
                        closedPar += 1;
                    }
                }

                if (openPar == closedPar || usersInputBox.getText().toString().startsWith("(", inboxLength - 1)){
                    //usersInputBox.setText(String.format("%s%s", usersInputBox.getText().toString(), "("));
                    usersInputBox.setText(updateText("(", usersInputBox.getText().toString(), usersInputBox.getSelectionStart()));
                }
                else if (closedPar < openPar && !usersInputBox.getText().toString().startsWith("(", inboxLength - 1)){
                    //usersInputBox.setText(String.format("%s%s", usersInputBox.getText().toString(), ")"));
                    usersInputBox.setText(updateText(")", usersInputBox.getText().toString(), usersInputBox.getSelectionStart()));
                }
                usersInputBox.setSelection(pos + 1);
    ...
    private void setupUI(){
        ...
        btnPar = findViewById(R.id.brackets);
